                ...
                <div className="row no-gutters">
                  ...
                  <div className="col-md-5 ">
                    <div className="info-wrap bg-primary rounded-5 text-white w-100 p-lg-5 p-4 right-side">
                      <h3 className="mb-4 mt-md-4 text-center">
                        Job Vista Details
                      </h3>
                      <div className="dbox w-100 d-flex align-items-start">
                        ...
                        <div className="text pl-3 p-3">
                          <span>Address:</span> Mumbai, Maharashtra, India
                        </div>
                      </div>
                      ...
                      <div className="dbox w-100 d-flex align-items-center">
                        ...
                        <div className="text pl-3 p-3">
                          <span>Email :</span> onlinejobportal@gmail.com
                        </div>
                      </div>
                      <div className="dbox w-100 d-flex align-items-center">
                        <div className="icon d-flex align-items-center justify-content-center">
                        ...
                        <div className="text pl-3 p-3">
                          <span>Website : </span> www.onlinejobportal.in
                        </div>
                      </div>
                    </div>
                  </div>
