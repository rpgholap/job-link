...
import {
  getLoggedJobSeeker,
  resetLoggedJobSeekerDetails,
} from "../redux/slices/JobSeeker/JobSeekerSlice";
      ...
      <Navbar collapseOnSelect expand="lg" variant="light">
        <Container>
          <NavbarBrand href="#home" className="logoo">
            {/* Main Logo */}
            <NavLink to="/">
              <img className="navbar-logo" src={logo} alt="JobVista Logo" />
            </NavLink>
          </NavbarBrand>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavLink
                to="/"
                className="ps-4 pe-4 navlinks-middle text-decoration-none menu-item"
              >
                Home
              </NavLink>
              {/* Find Jobs Button */}
              ...
              {recruiter.email == "" && jobSeeker.email == "" ? (
                ...
                <div className="d-flex justify-content-center">
                  <div className="dropdown" style={{ width: "160px" }}>
                    <img
                      className=" dropdown-toggle border-dark border rounded-5 cursor"
                      role="button"
                      src={
                        recruiter.email != ""
                          ? `data:image/jpeg;base64,${recruiter.companyLogoBase64}`
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                      ...
                      >
                        <button className="dropdown-item" type="button">
                          {recruiter.email != "" ? "Dashboard" : "Applied Jobs"}
                        </button>
                      </NavLink>
                      {jobSeeker.email == "" ? (
                        <NavLink
